"""
Django settings for programBlog project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db.sqlite3'), #entrara a configuracao de banco de dados
    }
}
...
#adicionado para deloy do site
ADMINS = (
    ('Daniel', 'danieldts2013@gmail.com'),
    )
...
#setar estes parametros de acordo com o servidor
SITE_HOST = ''
